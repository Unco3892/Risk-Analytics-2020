...
Interestingly, both the return level and the confidence line are higher compared to the maximum average waiting time in our data set. This suggests that even if visually we were not able to see a trend, actually there is one positive tren in our data. 
