...
Using the POT approach, we conclude that `r VaR_POT` is the average waiting time that is expected to be exceeded once every 250 open days (one year). Since this thresold is higher than the one obtained using the Block Maxima approach, will can also conclude that it has also been exceeded twice in the historical data.
