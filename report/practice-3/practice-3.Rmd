...
longChi_bar %>%
  ...
  labs(
    x = "product U",
    y = "product V",
    title = "Tail dependence for each pair of products at the 90% quantile",
...
longPval %>%
  ...
  labs(x="product", y="product", title="Tail dependence test for each pair of products at the 90% quantile", fill = "P-Value")
```
...
chiplot(cbind(sales_10_adj[,2], sales_10_adj[,3]), which = 2, main2 =  unname(latex2exp::TeX(" Chi Bar plot for product 2 & 3")))
```
